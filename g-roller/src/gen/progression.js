...
//   Same curve for every tier; the tier's `hazard` knob scales the resulting CHANCES
//   instead (so Hard plateaus busier, not just sooner). Output is 0..1.
...
export function danger(z) {
  return smoothstep(z / CONFIG.gen.dangerDistance);
}
